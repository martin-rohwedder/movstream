...
<div class="flow-container">
    ...
    <h3><spring:message code="flow.newmovie.page3.pagetitle.label" /></h3>

    <div class="span5">

        <p class="muted"><spring:message code="flow.newmovie.page3.pagedescription.label" /></p>

            <div id="new-movie-filename-group" class="control-group">
                <label class="control-label" for="inputMovieFilename"><strong><spring:message code="flow.newmovie.page3.form.moviefilename.label" /></strong></label>
            ...
            <div id="new-movie-picture-filename-group" class="control-group">
                <label class="control-label" for="inputPictureFilename"><strong><spring:message code="flow.newmovie.page3.form.picturefilename.label" /></strong></label>
                <div class="controls">
