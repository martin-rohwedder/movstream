...
<div class="flow-container">
    ...
    <h3><spring:message code="flow.newmovie.page1_5.pagetitle.label" /></h3>

    <div class="span4">

        <form:form modelAttribute="genreObject" action="${flowExecutionUrl}">
            <div id="new-movie-genre-title-group" class="control-group">
                <label class="control-label" for="inputGenreTitle"><strong><spring:message code="flow.newmovie.page1_5.form.genretitle.label" /></strong></label>
                <div class="controls">
