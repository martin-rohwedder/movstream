...
<div class="flow-container">
    ...
    <h3><spring:message code="flow.newmovie.page1.pagetitle.label" /></h3>

    <div class="span5">

        <p class="muted"><spring:message code="flow.newmovie.page1.pagedescription.label" /></p>
            ...
            <div id="new-movie-genre-group" class="control-group">
                <label class="control-label" for="inputGenre"><strong><spring:message code="flow.newmovie.page1.form.genre.label" /></strong></label>
                <div class="controls input-prepend">
                    ...
                    <div id="new-movie-description-group" class="control-group">
                        <label class="control-label" for="inputDescription"><strong><spring:message code="flow.newmovie.page1.form.description.label" /></strong></label>
                        <div class="controls">
