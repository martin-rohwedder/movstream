...
<div class="flow-container">
    ...
    <h3><spring:message code="flow.newmovie.page4.pagetitle.label" /></h3>

    <div class="span5">

        <p class="muted"><spring:message code="flow.newmovie.page4.pagedescription.label" /></p>

            <table class="table table-bordered table-striped table-condensed subtitle-table span5">
                <thead>
                    <tr>
                        <th><spring:message code="flow.newmovie.page4.table.subtitlefilename.label" /></th>
                        <th><spring:message code="flow.newmovie.page4.table.subtitlelanguage.label" /></th>
                        <th><spring:message code="flow.newmovie.page4.table.subtitlelanguagesrc.label" /></th>
                    </tr>
                </thead>
                <tbody>
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <div class="pull-right">
                <button type="submit" class="btn btn-warning" id="addsub" name="_eventId_addsub"><i class="icon-plus icon-white"></i> <strong><spring:message code="flow.newmovie.page4.form.button.addsubtitle.label" /></strong></button>
