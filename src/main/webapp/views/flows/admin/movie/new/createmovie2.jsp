    ...
    <div class="control-group">
        <div class="controls">
            ...
            <div class="pull-right">
                ...
                <button type="submit" class="btn btn-info" id="addtoseason" name="_eventId_next"><strong><spring:message code="flow.newmovie.page2.form.button.addtoseason.label" /></strong> <i class="icon-chevron-right icon-white"></i></button>
            </div>
        </div>
    </div>
</form:form>
