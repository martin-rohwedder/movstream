...
<div class="flow-container">
    ...
    <h3><spring:message code="flow.editmovie.page5.pagetitle.label" /></h3>

    <div class="span8">

        <p class="muted"><spring:message code="flow.editmovie.page5.pagedescription.label" /></p>
        ...
        <dl class="dl-horizontal">
            ...
            <dt><spring:message code="flow.editmovie.page5.details.moviefilename.label" /></dt>
            <dd><c:out value="${movieForm.movieFilename}" />.<c:out value="${movieForm.movieType.name}" /></dd>
            <dt><spring:message code="flow.editmovie.page5.details.picturefilename.label" /></dt>
            <dd><c:out value="${movieForm.pictureFilename}" /></dd>
            <dt><spring:message code="flow.editmovie.page5.details.subtitle.label" /></dt>
            <dd>
                <c:choose>
                    <c:when test="${empty movieForm.subtitles}">
                        <spring:message code="flow.editmovie.page5.details.nosubtitle.label" />
                    </c:when>
                    <c:otherwise>
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <div class="pull-right">
                ...
                <button type="submit" disabled="disabled" class="btn btn-success" id="savemovie" name="_eventId_savemovie"><i class="icon-ok-circle icon-white"></i> <strong><spring:message code="flow.editmovie.page5.form.button.savemovie.label" /></strong></button>
                </sec:authorize>
                <sec:authorize access="hasRole('ROLE_SUPERADMIN') or hasRole('ROLE_ADMIN')">
                <button type="submit" class="btn btn-success" id="savemovie" name="_eventId_savemovie"><i class="icon-ok-circle icon-white"></i> <strong><spring:message code="flow.editmovie.page5.form.button.savemovie.label" /></strong></button>
                </sec:authorize>
            </div>
        </div>
    </div>
