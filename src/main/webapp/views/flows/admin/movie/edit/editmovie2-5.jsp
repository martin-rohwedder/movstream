...
<div class="flow-container">
    ...
    <h3><spring:message code="flow.editmovie.page2_5.pagetitle.label" /></h3>

    <div class="span5">

        <form:form modelAttribute="seasonObject" action="${flowExecutionUrl}">
            <div id="edit-movie-season-title-group" class="control-group">
                <label class="control-label" for="inputSeasonTitle"><strong><spring:message code="flow.editmovie.page2_5.form.seasontitle.label" /></strong></label>
                <div class="controls">
                    <form:input class="span5" path="title" id="inputSeasonTitle" />
                </div>
            </div>

            <div id="edit-movie-season-description-group" class="control-group">
                <label class="control-label" for="inputSeasonDescription"><strong><spring:message code="flow.editmovie.page2_5.form.seasondescription.label" /></strong></label>
                <div class="controls">
