        ...
        <c:forEach items="${movies}" var="movie">
            <tr>
                ...
                <td style="width: 80px;">
                    ...
                    <a href="#modal-delete-container" data-id="<c:out value="${movie.id}" />" class="btn btn-danger btn-mini trigger-delete-movie disabled"><i class="icon-remove-circle icon-white"></i> <spring:message code="page.adminmanagemovie.button.delete.label" /></a>
                    </sec:authorize>
                    <sec:authorize access="hasRole('ROLE_SUPERADMIN') or hasRole('ROLE_ADMIN')">
                    <a href="#modal-delete-container" data-id="<c:out value="${movie.id}" />" class="btn btn-danger btn-mini trigger-delete-movie"><i class="icon-remove-circle icon-white"></i> <spring:message code="page.adminmanagemovie.button.delete.label" /></a>
                    </sec:authorize>
                </td>
            </tr>
        </c:forEach>
